                        ...
                        try {
                            ...
                            if (error.message.includes('429')) return;
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- HATA RAPORU [WhatsSiri] --*' + 
                                    ...
                                    '\n_Hatayı https://chat.whatsapp.com/BNtfhIbhlEwBrUvDOQFEW5 bu gruba iletebilirsiniz._\n\n' +
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [WhatsSiri] --*' + 
                                    ...
                                    '\n_Aslo you can join our support group:_ https://chat.whatsapp.com/BNtfhIbhlEwBrUvDOQFEW5' +
